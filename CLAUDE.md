...
- **Deliberately not built yet** (don't add speculatively): restore/snapshot browsing, retention/prune, extra backends, launchd scheduling, sandboxing.
